...
function insert_stuff($gambar_barang, $nama_barang, $kode_barang, $harga_barang, $stok_barang)
{
    ...
    $query = "INSERT INTO schoolstuff (kode_barang, nama_barang, harga_barang, stok_barang, gambar_barang)
...
function delete_stuff($kode_barang)
{
    ...
    $query = "DELETE FROM schoolstuff WHERE kode_barang = '$kode_barang'";
